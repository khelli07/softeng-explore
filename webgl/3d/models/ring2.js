...
for (let i = 0; i <= 355; i += 5) {
    ...
    for (let h = -0.1; h <= 0.1; h += 0.035) {     
        ...
        vertices.push(lowerOuterX, h + 0.035, lowerOuterZ, r, g, b); // 2
        ...
        vertices.push(lowerOuterX, h + 0.035, lowerOuterZ, r, g, b); // 3
    ...
    for (let h = -0.1; h <= 0.1; h += 0.035) {     
        ...
        vertices.push(lowerInnerX, h + 0.035, lowerInnerZ, r, g, b); // 2
        ...
        vertices.push(lowerInnerX, h + 0.035, lowerInnerZ, r, g, b); // 3
